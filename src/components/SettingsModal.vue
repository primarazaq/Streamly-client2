  ...
  >
    <v-card tile>
      <div class="d-flex justify-space-between mb-5" id="modal-header">
        <v-card-title class="py-3">Pengaturan</v-card-title>
      ...
      <v-card-text>
        <v-row>
          <v-col
            ...
            class="pt-0"
          >
            <h3 class="mb-6 mt-0 pt-0">Informasi Pribadi</h3>
            <ValidationObserver
            ...
            <h3 class="mb-6 mt-6">Ubah Password</h3>
            <ValidationObserver
              ref="passwordForm"
              v-slot="{ handleSubmit, reset }"
            >
          ...
          >
            ...
            <v-btn text @click="toggleShow">Upload Gambar</v-btn>
          </v-col>
        </v-row>
      </v-card-text>
    </v-card>
