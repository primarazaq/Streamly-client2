  ...
  <nav id="navbar">
    <v-app-bar class="white" flat app clipped-left>
      ...
      <v-menu offsetY>
        ...
        <v-list>
          <v-list-item router to="/studio/videos">
            ...
            >
            <v-list-item-title>Upload sebuah video</v-list-item-title>
          </v-list-item>
          <!-- <v-list-item>
            <v-list-item-icon class="mr-3"
      ...
      <v-btn
        ...
        to="/signin"
      >
        <v-icon left size="26">mdi-account-circle</v-icon> Masuk
      </v-btn>
        ...
        <v-card>
          ...
          <v-list>
            ...
            <v-list-item router to="/studio/videos">
              ...
              <v-list-item-title>Streamly Studio</v-list-item-title>
            </v-list-item>
        ...
        <v-list dense nav class="py-0" tag="div">
          ...
          >
            <v-app-bar-nav-icon
              ...
              class="mr-5"
            ></v-app-bar-nav-icon>
            <v-toolbar-title class="font-weight-bold">Streamly</v-toolbar-title>
          </v-list-item>
